...
import commitHash from '../../public/commit-hash.txt';

const CommitHashLink = ({ hash }) => {
  const commitUrl = `https://github.com/Shaglock/cod-camo-tracker/commit/${hash}`;
  return (
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4">
        <div className="w-full sm:flex-1">
          <input
            ...
            aria-label="Search weapons or categories" // Add ARIA label for accessibility
            value={searchTerm}
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-3">
        <div className="flex flex-row items-center gap-2 w-full sm:w-auto">
          <button
            ...
            aria-label="Reset all camouflages" // Add ARIA label for reset button
          >
      ...
      <footer className="text-center text-gray-500 text-sm mt-6">
        ...
        {commitHash && <div><CommitHashLink hash={commitHash} /></div>} {/* P1474 */}
      </footer>
    </div>
  );
}
